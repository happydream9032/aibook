...
const DropdownModal = (props: {
  ...
  return (
    ...
    >
      ...
      />
      {isShowMainDialog === 0 ? (<div className="top-left absolute left-0 shadow-lg rounded-xl bg-white ring-1 ring-black ring-opacity-5 mb-30">
